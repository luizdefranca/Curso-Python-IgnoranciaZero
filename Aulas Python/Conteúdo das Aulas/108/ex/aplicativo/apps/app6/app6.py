...
class Mario:
    def __init__(self, root):
        ...
        sheet2 = []
        for i in range(1, 5):
            sheet1.append(PhotoImage(file = os.path.join('apps' + os.sep + 'app6' + os.sep + 'mario', 'mario_%i.ppm'%i)))
            sheet2.append(PhotoImage(file = os.path.join('apps' + os.sep + 'app6' + os.sep + 'mario', 'mario_l%i.ppm'%i)))
